# GDD Core Rules (Platformer)

> Applies only to the fixed Phaser 3 2D platformer archetype. Config-First philosophy.
...
**View Direction**：所有角色动画使用 "SIDE VIEW facing RIGHT"。
...
See platformer guidance in `template_api.md` for:
...
See platformer `design_rules.md` for predefined ASCII map blueprints. Do not invent a layout outside those templates.
