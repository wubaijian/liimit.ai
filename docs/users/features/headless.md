...
opengame -p "Build a side-scrolling forest platformer with double jump and three patrolling enemies."

# allow shell commands as well
opengame -p "Build a forest platformer..." --yolo
# equivalent
opengame -p "Build a forest platformer..." --approval-mode yolo

# fully restrictive: nothing that would prompt is available
opengame -p "Build a forest platformer..." --approval-mode default
```
